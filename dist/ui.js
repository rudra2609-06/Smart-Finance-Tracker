...
export function renderTransaction(transactionsToRender) {
    ...
    const headerHTML = displayContainer.querySelector(".description-headers")?.outerHTML || "";
